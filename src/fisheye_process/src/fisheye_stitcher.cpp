                        ...
                        const cv::Mat &right_img_aligned )
{
    ...
    // 
    // std::cout<<"left_img_cr="<<left_img_cr.size()<<std::endl;
    // std::cout<<"right_img_aligned="<<right_img_aligned.size()<<std::endl;
...
FisheyeStitcher::stitch(const cv::Mat& in_img_L, const cv::Mat& in_img_R)
{
    ...
    // std::cout<<"left_unwarped_arr="<<left_unwarped_arr.size()<<std::endl;
    // std::cout<<"warpedRightImg="<<warpedRightImg.size()<<std::endl;
